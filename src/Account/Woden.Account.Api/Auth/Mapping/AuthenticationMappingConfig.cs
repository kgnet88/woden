...
public class AuthenticationMappingConfig : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        ...
        _ = config.NewConfig<ChangeEmailRequest, ChangeEmailCommand>();
        _ = config.NewConfig<ChangePasswordRequest, ChangePasswordCommand>();

        _ = config.NewConfig<GetUserInfoResult, GetUserInfoResponse>();
